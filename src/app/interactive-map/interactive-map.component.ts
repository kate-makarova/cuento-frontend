...
export class InteractiveMapComponent implements OnInit, AfterViewInit {
  ...
  public mapConfig = {
    ...
    marks: [
      ...
      { x: 1107, y: 390,  type: 'sietch', title: '' },
      ...
      { x: 2366, y: 1346, type: 'sietch', title: '' },
      ...
      { x: 1176, y: 319,  type: 'testingStation', title: '' },
      { x: 1148, y: 360,  type: 'testingStation', title: '' },
      ...
      { x: 1039, y: 528,  type: 'testingStation', title: '' },
